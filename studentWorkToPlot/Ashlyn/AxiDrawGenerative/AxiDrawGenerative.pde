...
// Change this
float perlinDelta = 2.7; // change this to change random behavior of perlin object 2.7

// User Settings: 
float MotorSpeed = 4000.0;  // Steps per second, 1500 default 4000.0
...
void setup() 
{
  ...
  //ToDoList = new int[0];
  PVector cmd = new PVector(0, 0);   // Command code: Go home (0,0)
...
void mousePressed() {
  ...
  else if ( brushUpButton.isSelected() )  
  {
    ...
    {     
      ToDoList = (PVector[]) append(ToDoList, new PVector(300, 0)); // Command 30 (raise pen) PVector(-30, 0)
    }
